...
<style>
  ...
  .lst_type li{overflow:hidden;clear:both:margin:10px 0 0;color:#2dc2d;
  ...
  <ul class="lst_type">
    ...
    <li>
      <a href="#" style="margin-left:50px">
        <img src="./image/sanho.jpg" width="90" height="90"/></a>
      <a href="#"><strong>이미지 이름 : 산호 <%=i %></strong></a>
      <a href="#"><input name="sh<%=i %>" type="checkbox"></a>
    </li>
      <% } %>
  </ul>
